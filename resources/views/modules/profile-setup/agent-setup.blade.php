                    ...
                    <div class="tab-content" style="display:block;">
                        ...
                        <div class="tab-pane" id="step2">
                            <form action="javascript:void(0)" id="step2Form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 common-label-css mt-1">
                                        <x-forms.crm-text-field :fieldData="[
                                            ...
                                            'help' => 'Please enter your name',
                                            {{-- 'isRequired' => true, --}}
                                            'value' => !empty($user->company_tax_number)
                                                ? $user->company_tax_number
                                                : '',
                                        ]" />
                                    </div>
                                    ...
                                    <div
                                        ...
                                        <x-forms.crm-radio-custom-for-profile-setup :fieldData="[
                                            ...
                                            'hasLabel' => true,
                                            'label' => trans('messages.profile-setup.num_of_sub_agents') . ':',
                                ...
                                @else
                                @include('modules.profile-setup.includes.agent-profile-overview',['showingOnSubAgentSide' => true])
                                @endif
                                <div class="text-end">
                                    <button type="button"
