@if (empty($showingOnSubDeveloperSide))
    ...
    <div class="border-r-12 b-color-white box-shadow-one  p-15">
        ...
        <div class="row row-border border-0">
            ...
            <div class="col-lg-6 d-flex align-items-start py-10 px-0 pb-0">
                <div class="text-14 color-primary font-weight-700 lineheight-18 me-1 d-flex">
                    ...
                    @if ($certificateData->isNotEmpty())
                        <span class="text-14 color-b-blue font-weight-400 lineheight-18">
                            @foreach ($certificateData as $certificate)
                                ...
                                @else
                                    <span onclick="window.open('{{ $certificate->certificate ?? '' }}','_blank')"
                                        data-bs-toggle="tooltip" data-bs-placement="bottom"
                                        title="{{ $certificate->original_name ?? '' }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                            viewBox="0 0 20 20" fill="none">
                    ...
                    @else
                        <div class="text-14 color-b-blue font-weight-400 lineheight-18 text-center"> &nbsp;N/A </div>
                    @endif
                </div>
            </div>
            <div class="col-lg-6 d-flex align-items-start py-10 px-0 pb-0">
                <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                    ...
                    @if (!empty($user->government_certification))
                        <span
                            class="text-14 color-b-blue font-weight-400 lineheight-18 icon-certificate_2 downloadGovtCertificateBtn"
                            data-id={{ $user->id }}>
                        </span>
                    @else
                    <span
                            class="text-14 color-b-blue font-weight-400 lineheight-18"> N/A
                        </span>
                    @endif
...
<div class="border-r-12 b-color-white box-shadow-one  mt-20 p-15">
    ...
    <div class="pt-3 pb-2">
        <img src="{{ !empty($companyDetails->company_image) ? getFileUrl($companyDetails->company_image, 'user_company_details') : asset('img/logoplaceholder.svg') }}"
    ...
    <div class="row row-border">
        ...
        <div class="col-lg-6 d-flex align-items-start py-10 px-0 border-white-twenty">
            <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                ...
                <span class="text-14 color-b-blue font-weight-400 lineheight-18">
                    {{ $companyDetails->company_email ?? 'N/A' }}
                </span>
            </div>
        </div>
    </div>
    <div class="row row-border">
        <div class="col-lg-6 d-flex align-items-start py-10 px-0 border-white-twenty">
            <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                ...
                <span class="text-14 color-b-blue font-weight-400 lineheight-18">
                    {{ $companyDetails->company_mobile ?? 'N/A' }}
                </span>
            </div>
        </div>
        <div class="col-lg-6 d-flex align-items-start py-10 px-0 border-white-twenty">
            <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                {{ trans('messages.profile-setup.cif_nie') . ':' }}
                <span class="text-14 color-b-blue font-weight-400 lineheight-18">
                    {{ $companyDetails->cif_nie ?? 'N/A' }}
                </span>
            </div>
        </div>
    </div>
    ...
    <div class="row row-border">
        <div class="col-lg-12 d-flex align-items-start py-10 px-0 border-white-twenty">
            <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                ...
                <span class="text-14 color-b-blue font-weight-400 lineheight-18">
                    {{ $companyDetails->company_website ?? 'N/A' }}</span>
            </div>
        </div>
    ...
    <div class="row row-border">
        <div class="col-lg-6 d-flex align-items-start py-10 px-0 border-white-twenty">
            <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                ...
                <span class="text-14 color-b-blue font-weight-400 lineheight-18">
                    {{ $companyDetails->primary_service_area ?? 'N/A' }}
                </span>
            </div>
        </div>
        <div class="col-lg-6 d-flex align-items-start py-10 px-0 border-white-twenty">
            <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                ...
                <span class="text-14 color-b-blue font-weight-400 lineheight-18">
                    {{ $companyDetails->professional_title ?? 'N/A' }}
                </span>
            </div>
        </div>
    ...
    <div class="row row-border">
        <div class="col-lg-6 d-flex align-items-start py-10 px-0 border-white-twenty">
            <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                ...
                <span
                    class="text-14 color-b-blue font-weight-400 lineheight-18">{{ !empty($total_properties_in_portfolio[$companyDetails->total_properties_in_portfolio])
                        ? $total_properties_in_portfolio[$companyDetails->total_properties_in_portfolio] . ' Properties'
                        : 'N/A' }}
                </span>
            </div>
        </div>
    ...
    <div class="row row-border">
        <div class="col-lg-12 d-flex align-items-center py-2 px-0 border-white-twenty">
            <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                ...
                <span class="text-14 color-b-blue font-weight-400 lineheight-18">
                    <span>{{ !empty($number_of_sub_agents[$companyDetails->company_sub_agent])
                        ? $number_of_sub_agents[$companyDetails->company_sub_agent] . ' Sub-Agents'
                        : 'N/A' }}
                    </span>
                </span>
            </div>
    ...
    <div class="row row-border">
        <div class="col-lg-12 d-flex align-items-start py-10 px-0 border-white-twenty">
            <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                ...
                <span
                    class="text-14 color-b-blue font-weight-400 lineheight-18">{{ !empty($total_years_experiance[$companyDetails->total_years_experiance])
                        ? $total_years_experiance[$companyDetails->total_years_experiance]
                        : 'N/A' }}</span>
            </div>
        </div>
    </div>
    <div class="row row-border border-0">
        <div class="col-lg-12 d-flex align-items-center py-2 px-0 pb-0 ">
            <div class="text-14 color-primary font-weight-700 lineheight-18 me-1">
                ...
                <span
                    class="text-14 color-b-blue font-weight-400 lineheight-18">{{ !empty($avg_number_properties_managed[$companyDetails->avg_number_properties_managed])
                        ? $avg_number_properties_managed[$companyDetails->avg_number_properties_managed]
                        : 'N/A' }}</span>
            </div>
        </div>
    </div>
...
@if (empty($showingOnSubDeveloperSide))
    ...
    <div class="modal fade" id="developer_review" tabindex="-1" role="dialog"
