...
<div id="page-content-wrapper" class="main-content-crm b-color-background  min-vh-100">
    ...
    <!-- ////////////////////////////////dashboard-card///////////////////////////////////////////// -->
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-lg-4 mb-3 pb-0 mb-md-3 pb-md-1 mb-lg-0 pb-lg-0 " onclick="window.open('','_self')">
            ...
            <div class="col-lg-8">
                <div class="dashboard-card_one  box-shadow-two b-color-white border-r-8 ">
                    ...
                    <div class="table_dashboard">
                        <table id="example" class="display dashboard_table"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>€4580.00</td>
                                    <td>Almería</td>
                                    <td><a href="#"><img src="http://127.0.0.1:8000/img/eye.svg" alt="image"></a></td>
                                </tr>
                                <tr>
                                    <td> <img src="/img/profile_1.png" alt="image" class="me-3"></td>
                                    <td><span>RT48</span></td>
                ...
                <div class="dashboard-card_one  box-shadow-two b-color-white border-r-8  mt-20">
                    ...
                    <div class="chart text-center">
                        <canvas id="myChart"
                            style="width:100%;max-width:1000px;margin-left:auto;margin-right:auto;"></canvas>
                    </div>
                </div>
            </div>
            <!-- ////////////////////////////upcoming-event////////////////////////////////////////////////////////// -->
...
<form method="post" enctype="multipart/form-data" class="form_file">
	<label for="apply"><input type="file" name="" id="apply" accept="image/*,.pdf">Upload From Browser</label>
</form> 
      ...
      <!-- <div class="modal-footer">
        ...
        <button
            class="text-align-start d-flex align-items-center b-color-transparent h-42 border-r-8 border-primary text-14 font-weight-400 lineheight-18 text-capitalize w100 dashboard_sidebar-button justify-content-center color-primary"><span
                class=" me-2 "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14"
                    fill="none">
                    <path fill-rule="evenodd" clip-rule="evenodd"
         ...
         <script>
                function initMap() {
                    ...
                    @foreach ($agentProperties as $property)
                        ...
                        var userIcon = {
                            url: '/img/location_map.svg', // Replace with the actual path to the marker icon
                            scaledSize: new google.maps.Size(40, 40), // Adjust the size as needed
                            origin: new google.maps.Point(0, 0),
                            anchor: new google.maps.Point(15, 15) // Adjust the anchor point if needed
                        };
                        ...
                        var userImage = {
                            url: '{{ asset("storage/users/" . $property->agentImage) }}', // Replace with the actual path to the user's image
                            scaledSize: new google.maps.Size(20, 20), // Adjust the size as needed
                            origin: new google.maps.Point(0, 0),
                            anchor: new google.maps.Point(10, 10), // Adjust the anchor point if needed
                        ...
                        var infoContent = '<div><img src="{{ asset("storage/properties/" . $property->property_img) }}" alt="Property Image" style="max-width: 50px; height: 50px;"></div>'+
                            '<div>{{ $property->name }}</div>' +
                            '<div class="icon-location-2">{{ $property->address }}</div>'+ 
                            '<div class="icon-Vector"> {{ $property->reference }}</div>';
                ...
                <div class="modal-content modal-content-file">
                    ...
                    <div class="modal-body modal-header_file">
                        ...
                        <div class="pt-30 modal-body_footer d-flex justify-content-between align-items-center">
                            ...
                            <form method="post" enctype="multipart/form-data" class="form_file">
                                <label for="apply"><input type="file" name="" id="apply" accept="image/*,.pdf">Upload
                                    From Browser</label>
                            </form>
                            <!-- <button type="button" class="modal-button border-r-8 b-color-Gradient text-12 font-weight-400 line-height-23 color-white mt-10 modal-confirm-btn-success">Logout</button> -->
                            <button type="button"
