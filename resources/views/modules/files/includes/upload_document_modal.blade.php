<div class="modal fade" id="uploadDocumentModal" data-current-action="" tabindex="-1" role="dialog"
        ...
        <div class="modal-content modal-content-file">
            <div class="modal-header border-0 modal-header_file pb-0">
                <a class ="gobackbtnevent d-none">
                    < Go Back </a>
                        ...
                        <button type="button" class="close b-color-transparent eventfileFolderModalClose"
            ...
            <div class="modal-body modal-header_file">
                <div class="modal_body_text uploadDocumentModalBody">
                    <div class="d-flex custom_width-modal-folder gap-3 d-none">
                                    ...
                                    <div class="d-flex align-items-center gap-30">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <a href="#"
                                                    class="color-primary text-10 text-decoration-underline pt-1">{{ $atachment->folderName }}</a>
                                            </div>
                ...
                <div class="pt-30 modal-body_footer d-flex justify-content-between align-items-center">
                    ...
                    <button type="button"
                        ...
                        onclick="openFolderModal()">Create New Folder </button>
                    <button type="button" style="background-color: #f0f0f0"
                        class="small-button border-r-8 text-14 font-weight-400 lineheight-18 color-white {{ !empty($uploadDcoumentsModal) ? $uploadDcoumentsModal : 'uploadDcoumentsModalSubmitBtn' }}"
                        disabled>
                        {{ !empty($submitBtnText) ? $submitBtnText : __('messages.uploads.import') }}</button>
                    <button type="button" style="background-color: #f0f0f0;"
                        class="Gradient_button small-button border-r-8 text-14 font-weight-400 lineheight-18 color-white d-none data_file_id">Save</button>
...
<div class="modal fade" id="create_new_folder" tabindex="-1"
    style="display: none;background: #00000040; z-index:99999;" role="dialog" aria-labelledby="create_new_folderLabel"
    aria-hidden="true">
        ...
        <div class="modal-content modal-content-file">
            <div class="modal-header border-0 modal-header_file pb-0">
                <h5 class="modal-title text-center text-18 font-weight-700 lineheight-22 color-primary w-100"
                    id="create_new_folderLabel">Create New Folde kapil</h5>
...
<script>
    ...
    function openFolderModal() {
        let myModal = new bootstrap.Modal(document.getElementById('create_new_folder'), {});
        myModal.show();
    }
    ...
    $(document).ready(function() {
        ...
        let folderId = null;
        let resumable;
        $(document).on('click', '.gobackbtnevent', function(e) {
            loadFolderData();
            ...
            $('.uploadDcoumentsModalSubmitBtn').prop('disabled', true);
            $('.gobackbtnevent').addClass('d-none');
            $('.gobackbtnevent').next('h4').removeClass('w-75').addClass('w-100');
            $('.gobackbtnevent').next('h4').text('Upload New File');
        ...
        $(document).on("click", ".eventsfolders", function(e) {
        ...
        function loadFiles(folderId) {
            ...
            const attributes = {
                ...
                handleSuccess: function() {
                    ...
                    $('.gobackbtnevent').removeClass('d-none').css('width', '10%');
                    $('.gobackbtnevent').next('h4').removeClass('w-100').addClass('w-75').text(datas[
                        'foldername']['name']);
                    $('.create_new_folder_btn').hide();
                    $('.form_file').show();
        ...
        $(document).on("change", ".uploadDocumentsCheckbox", function(e) {
            if ($('.uploadDocumentsCheckbox:checked').length > 0) {
                ...
                $('.uploadDcoumentsModalSubmitBtn').removeAttr("disabled")
            } else {
                $(".uploadDcoumentsModalSubmitBtn").removeClass("gradiant-button");
                $('.uploadDcoumentsModalSubmitBtn').attr('disabled', true);
            }
        });


        $(document).on("click", ".eventfileFolderModalClose", function(e) {
