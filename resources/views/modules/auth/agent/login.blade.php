...
<x-views.auth.auth-component :componentData='[
    ...
    "mainHeading" => trans("messages.agent.create_account"),
...
@php
    $mainFormFields = [
        ...
        $sideFormBtn = view('components.forms.crm-button', [
            'values' => [
                ...
                'url'  => route('agent.presonal-information'),
                'target' => '_self',
                'type' => 'button',
                'class' => 'login-white-button color-b-blue b-white-grey font-weight-500 lineheight-18 border-r-8 mt-2 border-white text-14',
                'id' => 'signInBtn',
                'attributes' => [],
    ...
    <x-slot name="mainAdditionalContent">
       ...
       <button class="border-r-8" type="button" onclick = "window.open('{{route('user.login.google')}}','_self')">
        ...
        <button class="border-r-8" type="button" onclick = "window.open('{{route('user.login.twitter')}}','_self')">
