...
@section('content')
    @push('styles')
                        ...
                        <div class="dashboard-card_one  box-shadow-two b-color-white border-r-8 ">
                            ...
                            <div class="property_type-empty-card mb-10">
                                ...
                                <div
                                    ...
                                    <span><i class=" icon-my_calender  icon-18 me-2 icon-12"></i>22/12/2023</span>
                                </div>
                            </div>
                            <div class="property_type-empty-card mb-10">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="search-dashboard d-flex justify-content-between flex-wrap gap-2">
                        ...
                        <div class="header-right-button_one d-flex align-items-center gap-12">
                            <a href="#"
                                class="text-14 color-primary font-weight-400 lineheight-18 text-decoration-underline text-capitalize">Manage
                                Agents</a>
                            <div class="header-right-button border-r-8 opacity-5 border-blue width-36 height-36 d-flex justify-content-center align-items-center"
                                data-bs-toggle="modal" data-bs-target="#dataFilterModal">
                        ...
                        <table id="example" class="display dashboard_table" style="width:100%; ">
                            ...
                            <tbody>
                                <tr>
                                    <td> <img src="/img/profile_1.png" alt="image"></td>
                                    <td><span>RT48</span></td>
                                    <td><span class="d-flex align-items-center gap-12"> <i
                                                class=" icon-my_project icon-18"></i> <i
                                                class=" icon-setting_managment  icon-18"></i> <i
                                                class=" icon-Agent_Management  icon-18"></i> <i
                                                class="  icon-Customer_Management  icon-18"></i> <i
                                                class=" icon-Task_Management-Icon  icon-18"></i> <i
                                                class=" icon-my_calender  icon-18"></i></span>
                                    </td>

                                    <td>Owner</td>
                                    <td><button onclick="myFunction()" class="table_dropdown_one"> <i
                                                class="  icon-dot  icon-16"></i></button>
                                        <div id="table_dropdown" class="table_dropdown-content">
                                            <a href="#"> <i class="icon-eye me-2"></i>View</a>
                                            <a href="#about"> <i class="icon-Delete me-2"></i>Remove</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><span class="d-flex align-items-center gap-12"> <i
                                                ...
                                                class="  icon-Customer_Management  icon-18"></i> <i
                                                class=" icon-Task_Management-Icon  icon-18"></i> <i
                                                class=" icon-my_calender  icon-18"></i></span></td>
                                    <td></td>
                                    <td><a href="#"> <i class="  icon-dot  icon-16"></i></a></td>
                                </tr>
                                <tr>
                                    <td> <img src="/img/profile_1.png" alt="image"></td>
                                    <td><span>RT48</span></td>
                                    <td><span class="d-flex align-items-center gap-12"> <i
                                                class="  icon-Customer_Management  icon-18"></i> <i
                                                class=" icon-Task_Management-Icon  icon-18"></i></span></td>
                                    <td></td>
                                    <td><a href="#"> <i class="  icon-dot  icon-16"></i></a></td>
                                </tr>
                                <tr>
            ...
            <div class="col-lg-12">
                ...
                <div class="table_dashboard table-dashboard_one table-dashboard_todolist">
                    <table id="example" class="display dashboard_table dashboard_edit_one" style="width:100%; ">
                        <thead>
                            <tr>
                                <th class="d-flex align-items-center gap-12"><input type="checkbox" id="vehicle1"
                                        name="vehicle1" value="Bike"><span>Task Name</span></th>
                                <th>Status</th>
                                <th>Deadline</th>
                                <th></th>
                            </tr>
                        ...
                        <tbody>
                            <tr>
                                <td class="d-flex align-items-center gap-12"><input type="checkbox" id="vehicle_one"
                                        name="vehicle1" value="Bike"><span class="change_decoration">Lorem Ipsum
                                        Lorem Ipsum Lorem Ipsum</span></td>
                                <td class="change_active"><span class="span_active span_complate_one">Active</span>
                                </td>
                                <td class="change_decoration">25/12/2022</td>
                                <td><a href="#"> <i class="  icon-Delete icon-20 color-b-blue"></i></a></td>
                            </tr>
                            <tr>
                                <td class="d-flex align-items-center gap-12"><input type="checkbox" id="vehicle1"
                                        name="vehicle1" value="Bike"><span>Lorem Ipsum Lorem
                                        Ipsum Lorem
                                        Ipsum</span></td>
        ...
        <div class="col-lg-6">
            <div class="dashboard-card_one  box-shadow-two b-color-white border-r-8  mt-20">
                <h4 class="text-18 font-weight-700 text-capitalize lineheight-22 letter-s-36 color-primary">Recent
                    Activity:
                </h4>
            <div
                class="table_dashboard empty-dashboard table-empty-dashboard_property recent-activity_height d-block pt-10 recent_activity_h-one">
                <div class="activity_before d-flex align-items- mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> marked <span
                                class="font-weight-700 color-b-blue">Ratnadeep Complex.</span> completed
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            13/01/2024, 08:34</div>
                    </div>
                </div>
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> scheduled meeting
                            event with <span class="font-weight-700 color-b-blue">Brian Baker</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            17/12/2023, 16:59</div>
                    </div>
                </div>
                <div class="activity_before d-flex align-items-start mb-30">
                    <div class="activity_img empty-image empty_image_top">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> scheduled view
                            meeting
                            event with<span class="font-weight-700 color-b-blue">Brian Baker</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            16/12/2023, 14:14</div>
                    </div>
                </div>
                <div class="activity_before d-flex align-items-start mb-30">
                    <div class="activity_img empty-image empty_image_top">
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> scheduled meeting
                            event with <span class="font-weight-700 color-b-blue"> Anita Bath</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                </div>
                <div class="activity_before d-flex align-items-start mb-30">
                    <div class="activity_img empty-image empty_image_top">
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> scheduled call event
                            with <span class="font-weight-700 color-b-blue"> Anita Bath</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> scheduled meeting
                            event with <span class="font-weight-700 color-b-blue"> Anita Bath & Brian
                                Baker</span>
                        </div>
                        <div class="color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            02/02/2023, 16:59</div>
                    </div>
                </div>
                <div class="activity_before d-flex align-items-start mb-30">
                    <div class="activity_img empty-image empty_image_top">
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> scheduled call event
                            with <span class="font-weight-700 color-b-blue">Anita Bath & Brian Baker</span>
                        </div>
                        <div class="color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            22/01/2023, 15:10</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    <div class="activity_img empty-image empty_image_top">
                        <i class=" icon-zip  icon-16 color-primary"></i>
                    </div>
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> removed <span
                                class="font-weight-400 color-b-blue"> Lorem Ipsum.Png</span>
                        </div>
                        <div class="color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            22/01/2023, 15:10</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> uploaded <span
                                class="font-weight-400 color-b-blue"> Lorem Ipsum.Zip</span>
                        </div>
                        <div class="color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            22/01/2023, 15:10</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> completed <span
                                class="font-weight-400 color-b-blue"> Call</span>
                        </div>
                        <div class="color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            22/01/2023, 15:10</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> added new task <span
                                class="font-weight-400 color-b-blue"> Call</span>
                        </div>
                        <div class="color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            22/01/2023, 15:10</div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> removed customer
                            <span class="font-weight-700 color-b-blue"> Brian Baker</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> imported new
                            customers
                            <span class="font-weight-700 color-b-blue"> Brian Baker, Mona Lott, Anita Bath,
                                Devon Lane, Khalil Cuellar Sevilla, Tracy Esparza Caraballo, Mariola Gonzales
                                Grijalva</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    <div class="activity_img empty-image empty_image_top">
                        <i class=" icon-agent   icon-16 color-primary"></i>
                    </div>
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> updated access
                            setting
                            of <span class="font-weight-700 color-b-blue"> Anita Bath</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> removed Agent <span
                                class="font-weight-700 color-b-blue"> Mona Lott</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> added new Agent <span
                                class="font-weight-700 color-b-blue"> Mona Lott</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> Removed property
                            <span class="font-weight-400 color-b-blue"> RT48</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> imported new property
                            <span class="font-weight-400 color-b-blue"> RT48</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    <div class="activity_img empty-image empty_image_top">
                        <i class=" icon-price  icon-16 color-primary"></i>
                    </div>
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> updated Project <span
                                class="font-weight-400 color-b-blue"> Price</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    <div class="activity_img empty-image empty_image_top">
                        <i class=" icon-location  icon-16 color-primary"></i>
                    </div>
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> updated Project <span
                                class="font-weight-400 color-b-blue"> Location</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    <div class="activity_img empty-image empty_image_top">
                        <i class=" icon-time  icon-16 color-primary"></i>
                    </div>
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> updated Project<span
                                class="font-weight-400 color-b-blue"> Deadline</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> updated Project <span
                                class="font-weight-400 color-b-blue"> Starting Date</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    <div class="activity_img empty-image empty_image_top">
                        <i class=" icon-description  icon-16 color-primary"></i>
                    </div>
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> updated Project <span
                                class="font-weight-400 color-b-blue"> Description</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> updated Project <span
                                class="font-weight-400 color-b-blue"> Investment</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
                ...
                <div class="activity_before d-flex align-items-start mb-30">
                    ...
                    <div class="activity_text ms-2">
                        <div class="color-light-grey-seven  text-14 font-weight-400 lineheight-18 text-capitalize">
                            <span class="font-weight-700 color-b-blue">James Henry</span> updated <span
                                class="font-weight-700 color-b-blue"> Ratnadeep Complex.</span>
                        </div>
                        <div class="mt-1 color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            21/02/2023, 18:59</div>
                    </div>
