...
@include('modules.files.includes.upload_document_modal', ['submitBtnText' => 'Send'])
...
@push('scripts')
    <script>
        console.log($socket)
        // var routeUrlStoreFiles = "{{ route(routeNamePrefix() . 'files.store') }}";
        ...
        $(document).ready(function() {
            ...
            function getSinglePrivateMessage(recordId) {
                ...
                const attributes = {
                    ...
                    handleSuccess: function() {
                        ...
                        scrollToBottom();
                        $("input[name = private_input_message]").val("");
            ...
            $socket.on('receiveMessage', function(msg) {
                ...
                if (typeof msg.chatfriendid !== 'undefined' && msg.chatuserid == chat_user_id) {
                    $(".user" + msg.chatuserid).find('.lastMessageText').text(msg.msg);
            ...
            $(document).on('keyup', 'input[name = private_input_message]', function() {
                $element = $("input[name = private_input_message]").val();
            ...
            function sendChatMessage(is_upload = 0, messageUpload = "") {
                var message = $("input[name = private_input_message]").val();
            ...
            $(document).on('click', '.uploadDcoumentsModalSubmitBtn', function() {
            ...
            $(document).on('keyup', 'input[name = group_input_message]', function() {
                $element = $("input[name = group_input_message]").val();
            ...
            function sendGroupChatMessage(is_upload = 0, messageUpload = "") {
                var message = $("input[name = group_input_message]").val();
            ...
            function getSingleGroupMessage(recordId, groupId) {
                ...
                const attributes = {
                    ...
                    handleSuccess: function() {
                        ...
                        $(".rightSideChatContent").find('.row').append(datas['data']);
                        scrollToBottom();
                        $("input[name = group_input_message]").val("");
