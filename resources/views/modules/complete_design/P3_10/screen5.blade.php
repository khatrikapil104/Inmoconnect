...
<div id="page-content-wrapper" class="main-content-crm b-color-background  min-vh-100">
    <div class="crm-main-content">
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="border-r-12 b-color-white box-shadow-one  p-10">
                    <!-- /////////////////search-button///////////// -->
                    ...
                    <div id="tab-2" class="tab-content current">
                        <div class="chat_m-second-card">
                            ...
                            <button class="w-100 h-42 b-color-transparent border-r-8 text-14 font-weight-400 lineheight-18 color-primary" data-toggle="modal" data-target="#todolist"><i class=" icon-plus color-primary me-2"></i>Create
                                    New Group</button>
                            </div>
                        ...
                        <div class="chat_message_second-card p-30">
                            ...
                            <div class="chat_bottom_text d-flex align-items-center mt-30">
                               ...
                               <button class="chat-meassage_document" data-toggle="modal" data-target="#exampleModal">
                                    <i class=" icon-send_document"></i>
                                </button>
                               <button class="chat-message_delivery">
                                     <i class=" icon-send_msg"></i>
                                </button>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="image-container  common-label-css">
                                            <label for="image" class="position-relative image-labelimage cursor-pointer">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="badge badge-pill badge-add d-block color-white text-16 line-height-20 font-weight-700">Edit</span>
                                                </div>
                                            </label>
                                    ...
                                    <div class="chat-m-button col-lg-5 d-flex justify-content-end pt-20 mt-1">
                                        <button
                                            ...
                                            data-toggle="modal" data-target="#todolist"><i
                                                class=" icon-edit icon-20"></i>Edit Group</button>
                                    </div>
                                </div>
                            </div>
                            <!-- ///////////////inner-tab-2//////////////////////// -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 pt-30 text-end">
                                        <div class="chat_box-two">
                                            ...
                                            <div class="pt-2 text-14 font-weight-400 lineheight-18 color-b-blue text-start">Good
                                                Moring!
                                            </div>
                                        </div>
                                    </div>
