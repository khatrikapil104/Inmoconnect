                                        ...
                                        <div class="col-lg-12 slider-main-card">
                                            <a href="login.php" class="slider_card" target="_blank" tabindex="0">
                                                ...
                                                <div class="slider-Agent d-flex  align-items-center">
                                                    <i class="icon-my_profile me-2 icon-16 color-b-blue"></i>
                                                    <div
                                                ...
                                                <div class="slider-Agent d-flex  align-items-center px-15">
                                                    <i class=" icon-my_calender me-2 icon-16 color-b-blue"></i>
                                                    <div
                                                        class="text-14 color-b-blue text-capitalize font-weight-400 lineheight-18">
                                                        Deadline:
                                                    </div>
                                                ...
                                                <div class="row px-15">
                                                    <div class="col-lg-6">
                                                        <div class="d-flex">
                                                            <i class=" icon-customer me-2 icon-18 color-b-blue"></i>
                            ...
                            <div class="col-lg-9">
                                <div class="gap-12 h-100 main-card-one-header d-flex flex-column justify-content-between">
                                    <div class="d-flex flex-column gap-12">
                                        ...
                                        <div
                                            class="flex-column flex-lg-row main-card-center-one  d-flex align-items-start gap-2 gap-md-3">
                                            <div class="d-flex gap-2 gap-md-3">
                                                <div class="d-flex gap-2 align-items-center">
                                                    <span class=" icon-bed icon-20 color-b-blue"></span>
                                                    <div
                                                        class="property-secondary text-14 font-weight-400 lineheight-18 color-b-blue">
                                                        2</div>
                                                </div>
                                                ...
                                                <div class="d-flex gap-2 align-items-center">
                                                    <span class="icon-bathroom icon-20 color-b-blue"></span>
                                                    <div
                                                        class="property-secondary text-14 font-weight-400 lineheight-18 color-b-blue">
                                                        2</div>
                                                </div>
                                                <div class="d-flex gap-2 align-items-center">
                                                    <span class="icon-floor icon-20 color-b-blue"></span>
                                                    <div
                                                        class="property-secondary text-14 font-weight-400 lineheight-18 color-b-blue">
                                                        2</div>
                                                </div>
                                            ...
                                            <div class="d-flex gap-2 gap-md-3">
                                                <div class="d-flex gap-2 align-items-center">
                                                    <span class=" icon-house_scale icon-20 color-b-blue"></span>
                                                    <div
                                                        class="property-secondary text-14 font-weight-400 lineheight-18 color-b-blue">
                                                        1,140.00 Sqft</div>
                                                </div>
                                                <div class="d-flex gap-2 align-items-center">
                                                    <span class=" icon-house_id icon-20 color-b-blue"></span>
                                                    <div
                                                        class="property-secondary text-14 font-weight-400 lineheight-18 color-b-blue">
                                                        16989-231042123</div>
                                                </div>
