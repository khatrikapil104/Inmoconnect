                                ...
                                <div class="col-lg-12">
                                    <div class="pt-3 d-flex align-items-center">
                                        <div class="personal_information_img">
                                            <img src="{{ asset('img/default-user.jpg') }}" alt="image" class="border-r-20"
                                                width="80" height="80">
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 pt-30">
                                    <div class="presonal_information_s_card">
                                        <div class="text-14 color-primary font-weight-700 lineheight-18">
                                            Government ID:</div>
                                        <div class="text-14 color-b-blue font-weight-400 lineheight-18 pt-2"><span
                                                class="me-2"><img src="{{ asset('img/default-user.jpg') }}" alt="image"
                                                    width="18" height="18"></span> Ivana_Tinkle_Government_ID</div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <div class="main-card_profile">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 pt-30">
                                    <div class="personal_information_img">
                                        <img src="{{ asset('img/default-user.jpg') }}" alt="image" class="border-r-12"
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 pt-30">
                                    <div class="presonal_information_s_card">
                                        ...
                                        <div class="text-14 color-b-blue font-weight-400 lineheight-18 pt-2">+56 123 456 789
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6 pt-30">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 pt-30">
                                    <div class="presonal_information_s_card">
                                        <div class="text-14 color-primary font-weight-700 lineheight-18">
                                            Company Website:</div>
                                        <div class="text-14 color-b-blue font-weight-400 lineheight-18 pt-2">realinmo.com
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6 pt-30">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6 pt-30">
                                    <div class="presonal_information_s_card">
                                        ...
                                        <div class="text-14 color-b-blue font-weight-400 lineheight-18 pt-2">11-50 Sub-Agent
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-6 pt-30">
