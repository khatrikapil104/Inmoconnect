                                ...
                                <div class="row ">
                                    <div class="col-lg-4 modal-header_file modal-header_color d-flex">
                                        <div class="modal-reject-img d-flex align-items-center justify-content-center">
                                            <img src="{{ asset('img/trial-beta-modal.svg') }}" alt="agent image">
                                        </div>
                                    </div>
                                    <div class="col-lg-8 modal-header_file ">
                                        ...
                                        <div class="modal_checkbox-h pt-30 text-center">
                                            <h4 class="text-16 color-primary font-weight-700">Your Free Trial of BETA Account is
                                                now expired!</h4>
                                            <h6 class="text-14 color-b-blue font-weight-400 pt-12">Please contact our admin team
                                                to help you on getting back your main account and enroll you into the launch
                                                queue of Inmoconnect CRM full access.</h6>
                                            <h6 class="text-16 color-primary font-weight-700 pt-20 mb-3">Contact Us Via Chat
                                            </h6>
                                            <button type="button"
