                        ...
                        <div class="col-lg-12">
                            <div class="pt-3 d-flex align-items-center">
                                <div class="personal_information_img">
                                        <img src="{{ asset('img/default-user.jpg') }}" alt="image"
                                        class="border-r-20" width="80" height="80">
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 pt-30">
                            <div class="presonal_information_s_card">
                                ...
                                <div class="text-14 color-b-blue font-weight-400 lineheight-18 pt-2">101-1000 Properties
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 pt-30">
