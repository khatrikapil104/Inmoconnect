                                ...
                                <div class="col-lg-3 mt-3 mt-lg-0">
                                    <div
                                        ...
                                        <div class="button-icon d-flex gap-2 gap-md-3 justify-content-end">
                                            ...
                                            <button type="button" class=" icon-edit text-20 b-color-transparent color-b-blue"
                                                id="editBtn">
                                            </button>
                                            <button type="button" class=" icon-Delete text-20 b-color-transparent color-b-blue"
                                                id="deleteBtn">
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 mt-3 mt-lg-0">
                                    <div
                                        ...
                                        <div class="button-icon d-flex gap-2 gap-md-3 justify-content-end">
                                            <button type="button"
                                                class=" icon-share text-20 b-color-transparent color-b-blue" id="shareBtn">
                                            </button>
                                            <button type="button"
                                                class=" icon-edit text-20 b-color-transparent color-b-blue" id="editBtn">
                                            </button>
                                            <button type="button"
                                                class=" icon-Delete text-20 b-color-transparent color-b-blue" id="deleteBtn">
                                            </button>
                                        </div>
                                    </div>
                                </div>
