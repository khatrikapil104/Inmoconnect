            ...
            <div class="crm-main-content">
                ...
                <div class="dashboard-card_one  box-shadow-two b-color-white border-r-8  mt-20 p-30">
                    <div class="search-dashboard d-flex justify-content-between flex-wrap gap-2">
                        ...
                        <button type="button"
                            class="Gradient_button w-150 height-40 border-r-8 b-color-Gradient text-14 font-weight-400 lineheight-18 color-white ">Create</button>
                    </div>
                        ...
                        <table id="example_one" class="display  dashboard_edit_one" style="width:100%; ">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><button class="b-color-transparent" data-toggle="modal" data-target="#todolist"><img
                                                src="/img/smile.svg" alt="image" class=""></button></td>
                                </tr>
                                <tr>
                                    <td> <img src="/img/profile_1.png" alt="image"><span class="ms-2">Brian Baker</span>
                                    </td>
                                    ...
                                    <td><button class="b-color-transparent" data-toggle="modal" data-target="#cancelbutton"><img
                                                src="/img/delete.svg" alt="image" class=""></button></td>
                                </tr>
                                <tr>
                                    <td> <img src="/img/profile_1.png" alt="image"><span class="ms-2">Brian Baker</span>
                                    </td>
                                    ...
                                    <td>-----</td>
                                    <td class="change_active"><span class="span_active span_complate_one">Active</span></td>
                                    <td><button data-toggle="modal" data-target="#todolist"><img src="/img/smile.svg"
                                                alt="image" class=""></button></td>
                                </tr>
                                <tr>
                                    <td> <img src="/img/profile_1.png" alt="image"><span class="ms-2">Brian Baker</span>
                                    </td>
