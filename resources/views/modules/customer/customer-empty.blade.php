                    ...
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-6 empty-order">
                            <div class="search-left me-4">
                                <div class="text-20 lineheight-22 color-primary font-weight-700 letter-s-48">
                                     Empower Your Clients: Seamless Customer Onboarding with InmoConnect
                                    {{trans('messages.my-customers.Empower_Your_Clients')}}
                                </div>
                                <div class="text14 font-weight-400 lineheight-18 color-b-blue pt-10">Why Your Clients Will Love InmoConnect Invitations?</div>
                                <ul class="search-list">
                                    <li class="text14 font-weight-400 lineheight-18 color-b-blue pt-15"><span
                                            class="font-weight-700">Seamless Onboarding:</span>  Easily invite customers to join your real estate network for a hassle-free onboarding experience.</li>
                                    <li class="text14 font-weight-400 lineheight-18 color-b-blue pt-15"><span
                                            class="font-weight-700">Unified Collaboration:</span>  Foster closer connections by bringing your clients into the heart of your real estate ventures on InmoConnect.</li>
                                    <li class="text14 font-weight-400 lineheight-18 color-b-blue pt-15"><span
                                            class="font-weight-700">Efficient Communication:</span> Streamline communication with your clients, keeping them informed about properties, negotiations, and more.</li>
                                    <li class="text14 font-weight-400 lineheight-18 color-b-blue pt-15"><span
                                            class="font-weight-700">Exclusive Property Access:</span> Offer your clients exclusive access to curated property listings, ensuring they stay engaged and invested.</li>
                                    <li class="text14 font-weight-400 lineheight-18 color-b-blue pt-15"><span
                                            class="font-weight-700">Real-Time Updates:</span>Keep your clients in the loop with real-time updates on property developments and market trends.</li>
                                </ul>
                                <div class="text14 font-weight-400 lineheight-18 color-b-blue pt-15">Start inviting customers to join InmoConnect today - Where Collaboration Meets Real Estate Excellence!</div>
                            </div>
                        </div>
                        <div class="col-lg-6">
...
<div class="modal fade" id="dataFilterModal" tabindex="-1" aria-labelledby="dataFilterModalLabel" style="display: none;"
            ...
            <div class="modal-body modal-body modal-header_file">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 common-label-css">
                        <div class="form-group mt-3 position-relative">
                            <label for="vendor_name"
                                class="text-14 font-weight-400 lineheight-18 color-b-blue">First Name:
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 common-label-css">
                        <div class="form-group mt-3 position-relative">
                            <label for="vendor_name"
                                class="text-14 font-weight-400 lineheight-18 color-b-blue">Last Name:
                                <span class="required">*</span></label>
                            <input type="text"
                                class="form-control border-r-8 border-blue b-color-transparent text-14 font-weight-400 lineheight-18 color-b-blue height-46 "
                                name="vendor_name" id="vendor_name" value="" placeholder="">
  ...
  <div class="col-12 col-sm-6 col-md-6 col-lg-6 common-label-css">
                    ...
                    <div class="col-12 col-sm-6 col-md-6 col-lg-6 common-label-css">
                        <div class="form-group mt-3 position-relative">
                            <label for="vendor_name"
                                class="text-14 font-weight-400 lineheight-18 color-b-blue">Mobile Number:
                                <span class="required">*</span></label>
                            <input type="text"
                                class="form-control border-r-8 border-blue b-color-transparent text-14 font-weight-400 lineheight-18 color-b-blue height-46 "
                                name="vendor_name" id="vendor_name" value="" placeholder="">
                ...
                <div class="pt-30 modal-body_footer d-flex justify-content-end align-items-center">
                    <button type="button" class="Gradient_button small-button border-r-8 b-color-Gradient text-14 font-weight-400 lineheight-18 color-white ">invite Customer </button>
                </div>
            </div>
