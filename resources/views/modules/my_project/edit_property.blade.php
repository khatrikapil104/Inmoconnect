                ...
                <div class="col-lg-6">
                    ...
                    <div class="search-dashboard d-flex justify-content-between flex-wrap gap-2">
                        ...
                        <div class="header-right-button_one d-flex align-items-center gap-12">
                            ...
                            <div class="header-right-button border-r-8 opacity-5 border-blue width-36 height-36 d-flex justify-content-center align-items-center"
                                data-bs-toggle="modal" data-bs-target="#dataFilterModal">
                                <img src="/img/dashboard_agent.svg" alt="image" class="">
                            </div>
                        </div>
                    </div>
                        ...
                        <table id="example" class="display dashboard_table" style="width:100%; ">
                            ...
                            <tbody>
                                <tr>
                                    <td> <img src="/img/profile_1.png" alt="image"></td>
                                    <td><span>RT48</span></td>
                                    <td><span class="d-flex align-items-center gap-12"><img src="/img/agent_one.svg"
                                                alt="image" class=""><img src="/img/agent_two.svg" alt="image"
                                                class=""><img src="/img/agent_three.svg" alt="image"
                                                class=""><img src="/img/agent_four.svg" alt="image"
                                                class=""><img src="/img/agent_five.svg" alt="image"
                                                class=""><img src="/img/agent_six.svg" alt="image"
                                                class=""></span>
                                    </td>

                                    <td>Owner</td>
                                    <td><button onclick="myFunction()" class="table_dropdown_one"><img
                                                src="/img/dashboard_dot.svg" alt="image" class=""></button>
                                        <div id="table_dropdown" class="table_dropdown-content">
                                            <a href="#"><img src="http://127.0.0.1:8000/img/eye.svg" alt="image"
                                                    class="me-2">View</a>
                                            <a href="#about"><img src="/img/delete.svg" alt="image"
                                                    class="me-2">Remove</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td><span class="d-flex align-items-center gap-12"><img src="/img/agent_one.svg"
                                                ...
                                                class=""></span></td>
                                    <td></td>
                                    <td><a href="#"> <img src="/img/dashboard_dot.svg" alt="image"
                                                class=""></a></td>
                                </tr>
                                <tr>
                                    <td> <img src="/img/profile_1.png" alt="image"></td>
                                    <td><span>RT48</span></td>
                                    <td><span class="d-flex align-items-center gap-12"><img src="/img/agent_four.svg"
                                                alt="image" class=""><img src="/img/agent_five.svg" alt="image"
                                                class=""></span></td>
                                    <td></td>
                                    <td><a href="#"> <img src="/img/dashboard_dot.svg" alt="image"
                                                class=""></a></td>
                                ...
                                <tr>
                                    ...
                                    <td><span>RT48</span></td>
                                    <td><span class="d-flex align-items-center gap-12"><img src="/img/agent_one.svg"
                                                alt="image" class=""><img src="/img/agent_four.svg" alt="image"
                                                class=""><img src="/img/agent_five.svg" alt="image"
                                                class=""><img src="/img/agent_six.svg" alt="image"
                                                class=""></span></td>
                                    <td></td>
            ...
            <div class="col-lg-6">
                ...
                <div class="search-dashboard d-flex justify-content-between flex-wrap gap-2">
                    ...
                    <div class="header-right-button_one d-flex align-items-center gap-12">
                        ...
                        <div class="header-right-button border-r-8 opacity-5 border-blue width-36 height-36 d-flex justify-content-center align-items-center"
                            data-bs-toggle="modal" data-bs-target="#dataFilterModal">
                            <img src="/img/dashboard_customer.svg" alt="image" class="">
                        </div>
                    </div>
                </div>
                <div class="table_dashboard table-dashboard_two">
                    <table id="example" class="display dashboard_table" style="width:100%; ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Ivana Tinkle</td>
                                <td><a href="#"> <img src="/img/dashboard_dot.svg" alt="image" class=""></a>
                                </td>
                            </tr>
                            <tr>
                                <td> <img src="/img/profile_1.png" alt="image"></td>
                        ...
                        <tbody>
                            <tr>
                                <td class="d-flex align-items-center gap-12"><input type="checkbox" id="vehicle_one"
                                        name="vehicle1" value="Bike"><span class="change_decoration">Lorem Ipsum Lorem
                                        Ipsum Lorem Ipsum</span></td>
            ...
            <div
                ...
                <div class="activity_before d-flex align-items- mb-30">
                    <div class="activity_img empty-image empty_image_top">
                        <img src="/img/managment_two.svg" alt="image" class="">
                    </div>
                    <div class="activity_text ms-2">
                        <div class="color-b-blue text-14 font-weight-400 lineheight-18 text-capitalize"><span
                                class="font-weight-700">James Henry</span> Initiated project <span
                                class="font-weight-700">Ratnadeep Complex.</span></div>
                        <div class="color-light-grey-six text-14 font-weight-400 lineheight-18 text-capitalize">
                            5 Mins ago</div>
                    </div>
                </div>
                <div class="activity_before d-flex align-items-center mb-30">
                    <div class="activity_img empty-image empty_image_top">
                        <img src="/img/managment_one.svg" alt="image" class="">
                    </div>
                    <div class="activity_text ms-2">
                        <div class="color-b-blue text-14 font-weight-400 lineheight-18 text-capitalize"><span
                                class="font-weight-700">James Henry</span> Initiated project <span
