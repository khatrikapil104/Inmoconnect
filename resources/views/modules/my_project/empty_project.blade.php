                            ...
                            <div class="row d-flex align-items-center">
                                <div class="col-lg-6 empty-order">
                                    <div class="search-left me-4">
                                        <div class="text-20 lineheight-22 color-primary font-weight-700 letter-s-48">Transform
                                            Visions into Reality with InmoConnect Projects</div>
                                        <div class="text14 font-weight-400 lineheight-18 color-b-blue pt-10">Why Utilize
                                            InmoConnect Projects?</div>
                                        <ul class="search-list">
                                            <li class="text14 font-weight-400 lineheight-18 color-b-blue pt-15"><span
                                                    class="font-weight-700">Efficient Collaboration:</span> Work seamlessly with
                                                your team, agents, and clients within a unified workspace.</li>
                                            <li class="text14 font-weight-400 lineheight-18 color-b-blue pt-15"><span
                                                    class="font-weight-700">Centralized Management:</span> Keep all
                                                project-related information, from properties to contacts, in one organized
                                                space.</li>
                                            <li class="text14 font-weight-400 lineheight-18 color-b-blue pt-15"><span
                                                    class="font-weight-700">Transparent Progress Tracking:</span> Monitor the
                                                progress of each project with real-time updates and milestones.</li>
                                            <li class="text14 font-weight-400 lineheight-18 color-b-blue pt-15"><span
                                                    class="font-weight-700">Document Centralization:</span> Store, share, and
                                                manage project documents securely in one centralized location.</li>
                                            <li class="text14 font-weight-400 lineheight-18 color-b-blue pt-15"><span
                                                    class="font-weight-700">Effortless Meetings</span> Schedule and manage
                                                project meetings effortlessly with our in-built meeting scheduler.</li>
                                        </ul>
                                        <div class="text14 font-weight-400 lineheight-18 color-b-blue pt-15">Start your first
                                            InmoConnect Project today and turn your real estate visions and excellence into
                                            successful ventures.</div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 common-label-css common_css_two">
                                <div class="form-group position-relative">
                                    <label for="reference" class="text-14 font-weight-400 lineheight-18 color-b-blue">Project
                            ...
                            <div class="col-12 col-sm-6 col-md-6 col-lg-6 common-label-css">
                                <div class="form-group mt-3 position-relative">
                                    <label for="vendor_name" class="text-14 font-weight-400 lineheight-18 color-b-blue">Project
                                        Type:
                            ...
                            <div class="col-12 col-sm-12 col-md-12  col-lg-12 common-label-css">
                                <div class="form-group mt-3 position-relative">
                                    <label for="vendor_name" class="text-14 font-weight-400 lineheight-18 color-b-blue">Add
                                        Attachments:
