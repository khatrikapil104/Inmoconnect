...
@section('title')
{{trans('messages.newsletters.newletters')}} Inmoconnect
@endsection
    ...
    <div class="crm-main-content">
            ...
            <div class="header-title d-flex align-items-center justify-content-between">
                <div class="header-left-breadcrumb d-flex align-items-center">
                    <h3
                        ...
                        {{trans('messages.newsletters.newletters')}}
                </h3>
                </div>
        ...
        <div class="dashboard-card_one  box-shadow-two b-color-white border-r-8 p-30">
            <div class="search-dashboard d-flex justify-content-between flex-wrap gap-2">
                ...
                <button type="button" onclick="window.open('{{route(routeNamePrefix().'newsletters.exportNewsletters')}}','_self')"
            ...
            <div class="table_customer-three pt-10">
                <table id="example_one" class="display  dashboard_edit_one" style="width:100%; ">
                    <thead>
                        <tr>
                            <th>{{trans('messages.newsletters.Email')}}</th>
                            <th>{{trans('messages.newsletters.Subscribed_On')}}</th>
                    ...
                    <tbody class="tableData">
                        ...
                        <tr>
                            <td colspan="2" class="text-center">
                                ...
                                <p>{{trans('messages.newsletters.No_newsletters_found')}}</p>
                            </td>
                        </tr>
                        @endif
                    </tbody>
