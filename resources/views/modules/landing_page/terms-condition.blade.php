...
<head>
    ...
    <title>{{trans('messages.landing_page.Footer_terms')}}</title>
                    ...
                    <div class="col-12">
                        <div class="key-feature-m-text text-center demo-section-text">
                            <h2 class="color-primary position-relative d-inline text-capitalization">
                                {{trans('messages.terms_page.main')}}
                            </h2>
                        </div>
                    </div>

                    <div class="terms_text">
                        <h5 class="color-b-blue mt-20"> {{trans('messages.terms_page.small_text_one')}} <a
                                href="https://staging.inmoconnect.brisktechalmas.com/landing_page">
                                {{trans('messages.terms_page.small_text_two')}}</a>,
                            {{trans('messages.terms_page.small_text_three')}}</h5>

                        <p><strong> {{trans('messages.terms_page.strong_1')}}</strong>
                            {{trans('messages.terms_page.small_text-1')}}</p>
                        <p><strong>{{trans('messages.terms_page.strong_2')}}</strong> A
                            {{trans('messages.terms_page.small_text-2')}}</p>
                        <p><strong>{{trans('messages.terms_page.strong_3')}}</strong>
                            {{trans('messages.terms_page.small_text-3')}}</p>
                        <p><strong>{{trans('messages.terms_page.strong_4')}}</strong>
                            {{trans('messages.terms_page.small_text-4')}}</p>
                        <p><strong>{{trans('messages.terms_page.strong_5')}}</strong>
                            {{trans('messages.terms_page.small_text-5')}}</p>
                        <p><strong>{{trans('messages.terms_page.strong_6')}}</strong>
                            {{trans('messages.terms_page.small_text-6')}}
                        <ul>
                            <li> {{trans('messages.terms_page.list_1')}}</li>
                            <li>{{trans('messages.terms_page.list_2')}}</li>
                            <li>{{trans('messages.terms_page.list_3')}}</li>
                            <li>{{trans('messages.terms_page.list_4')}}</li>
                        </ul>

                        <p><strong>{{trans('messages.terms_page.strong_7')}}</strong>
                            {{trans('messages.terms_page.small_text-7')}}</p>
                        <p><strong>{{trans('messages.terms_page.strong_8')}}</strong>
                            {{trans('messages.terms_page.small_text-8')}}</p>
                        <p><strong>{{trans('messages.terms_page.strong_9')}}</strong>
                            {{trans('messages.terms_page.small_text-9')}}</p>
                        <p><strong>{{trans('messages.terms_page.strong_10')}}</strong>
                            {{trans('messages.terms_page.small_text-10')}}</p>
                        <p><strong>{{trans('messages.terms_page.strong_11')}}</strong>
                            {{trans('messages.terms_page.small_text-11')}}</p>
                        <p><strong>{{trans('messages.terms_page.strong_12')}}</strong>
                            {{trans('messages.terms_page.small_text-12')}} <a
                                href="mailto:business@inmoconnect.com">{{trans('messages.landing_page.form_email')}}</a>
                        </p>
                        <p>{{trans('messages.terms_page.small_text-13')}}</p>
                    </div>
                </div>
            </div>
        </section>
