...
function loadPropertiesData() {
    ...
    $(".propertyTableData").find(".table-dashboard-data").addClass("loader");
    formData.append("type", 'agent_properties');
    formData.append(
        "table_search_input",
    ...
    const attributes = {
        ...
        handleSuccess: function() {
            $(".propertyTableData").find(".table-dashboard-data").removeClass("loader");
            $(".propertyTableData").find(".no_data_found").empty();
            if (datas["properties"]['data'].length > 0) {
                ...
                $(".propertyTableData").find(".table-dashboard-data").remove();
                $(".propertyTableData").find(".no_data_found").html(datas["data"]);
            }
        },
        handleError: function() {
            $(".propertyTableData")
                .find(".table-dashboard-data")
                .removeClass("loader");
        },
