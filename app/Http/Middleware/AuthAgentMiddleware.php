...
class AuthAgentMiddleware
{
    ...
    {   
        ...
        if(Auth::user()->role->name == 'superadmin' || Auth::user()->role->name == 'admin' || Auth::user()->role->name == 'customer'|| Auth::user()->role->name == 'sub-agent'|| Auth::user()->role->name == 'sub-developer' || Auth::user()->role->name == 'developer'){
