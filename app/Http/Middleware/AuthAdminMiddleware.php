...
class AuthAdminMiddleware
{
    ...
    {   
        ...
        if(Auth::user()->role->name == 'agent' || Auth::user()->role->name == 'customer' || Auth::user()->role->name == 'sub-agent' || Auth::user()->role->name == 'sub-developer' || Auth::user()->role->name == 'developer'){
